...
class TestCheckpointIndex(unittest.TestCase):
    ...
    def test_to_from_dict(self):
        ...
        index = CheckpointIndex(
            checkpoints={'test_001': metadata1},
            last_full_checkpoint_id='test_001'
        )
...
class TestCloudBackupStubs(unittest.TestCase):
    ...
    def test_cloud_config(self):
        ...
        self.assertEqual(
            self.checkpoint.cloud_backup_config.provider,
            CloudBackupProvider.AWS_S3
        )
    ...
    def test_configure_cloud_backup(self):
        ...
        self.assertEqual(
            self.checkpoint.cloud_backup_config.provider,
            CloudBackupProvider.AZURE_BLOB
        )
    ...
    def test_sort_by_size(self):
        ...
        for i in range(len(checkpoints) - 1):
            self.assertGreaterEqual(
                checkpoints[i].size_bytes,
                checkpoints[i+1].size_bytes
            )
