...
async def test_streaming_bayesian_updater():
    ...
    prior = MechanismPrior('educación', 0.5, 0.2, 0.5)  # Use 'educación' to match chunk content
    ...
    assert_greater_equal(posterior.evidence_count, 0)  # At least 0 (may be 0 if no relevant chunks)
