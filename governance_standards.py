...
class AuditLogEntry:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "outputs": {k: str(v)[:200] if isinstance(v, (list, dict)) else v 
...
class ImmutableAuditLog:
    ...
    def query_by_source_hash(self, sha256_source: str) -> List[AuditLogEntry]:
        ...
        return [
            ...
            if entry.sha256_source == sha256_source
        ]
...
if __name__ == "__main__":
    ...
    print(f"✓ Necessity test: {'PASSED' if payload.necessity_test_passed else 'FAILED'}")
