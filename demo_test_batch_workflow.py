...
def demo_basic_workflow():
    ...
    for i in range(3):
        ...
        workflow.record_and_test(
            demo_files[i],
            f"Refactored function_{i} for better performance"
        )
        time.sleep(0.5)
        print()
    ...
    for i in range(3, 6):
        ...
        workflow.record_and_test(
            demo_files[i],
            f"Added error handling to function_{i}"
        )
        time.sleep(0.5)
        print()
...
def demo_rollback_scenario():
    ...
    for i in range(3):
        ...
        workflow.record_and_test(
            demo_files[i],
            f"Updated critical_module_{i} - CAUTION"
        )
...
def demo_cli_commands():
    ...
    commands = [
        ("Record an edit", "python batch_test_automation.py record myfile.py --desc 'Fixed bug'"),
        ...
        ("Custom batch size", "python batch_test_automation.py --batch-size 10 record file.py"),
    ]
