...
class CatalogoCompetenciasMunicipales:
    ...
    def validar_competencia_municipal(
        self, sector: str, descripcion: str
    ) -> Dict[str, Any]:
        """
    ...
    def generar_reporte_competencias(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "por_tipo": {
                tipo.value: len(self.get_by_tipo(tipo)) for tipo in TipoCompetencia
            },
        }
...
if __name__ == "__main__":
    ...
    resultado = catalogo.validar_competencia_municipal(
        "educacion", "Construcción de escuela rural"
    )
