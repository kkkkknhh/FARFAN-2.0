...
def example_pipeline_with_observability():
    ...
    # Phase 1: Extraction
    with observability.trace_operation('extract_document', plan='PDM_EXAMPLE_001') as span:
    ...
    with observability.trace_operation('bayesian_inference', chains=4) as span:
        ...
        observability.record_nonconvergent_chain(
            'chain_3',
            'R_hat=1.15 exceeds threshold of 1.1'
        )
    ...
    with observability.trace_operation('validate_evidence') as span:
        ...
        observability.record_hoop_test_failure('D1-Q5', ['regulatory_constraint_missing'])
