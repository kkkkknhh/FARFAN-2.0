...
def test_orchestrator_execution():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert result["orchestration_metadata"]["calibration"]["coherence_threshold"] == COHERENCE_THRESHOLD
...
def test_deterministic_behavior():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result1 = orch.orchestrate_analysis(test_text, "PDM_Determinism_Test", "estratégico")
        ...
        result2 = orch.orchestrate_analysis(test_text, "PDM_Determinism_Test", "estratégico")
