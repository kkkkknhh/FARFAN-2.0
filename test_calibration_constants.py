...
class TestCalibrationConstants(unittest.TestCase):
    ...
    def test_severity_threshold_ordering(self):
        ...
        self.assertGreater(
            CALIBRATION.CRITICAL_SEVERITY_THRESHOLD, CALIBRATION.HIGH_SEVERITY_THRESHOLD
        )
        self.assertGreater(
            CALIBRATION.HIGH_SEVERITY_THRESHOLD, CALIBRATION.MEDIUM_SEVERITY_THRESHOLD
        )
    ...
    def test_override_calibration(self):
        ...
        self.assertEqual(
            custom.CAUSAL_INCOHERENCE_LIMIT, CALIBRATION.CAUSAL_INCOHERENCE_LIMIT
        )
