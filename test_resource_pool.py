...
def test_resource_config_validation():
    ...
    config = ResourceConfig(
        max_workers=4, worker_timeout_secs=60, worker_memory_mb=1024
    )
...
def test_worker_creation():
    ...
    worker = Worker(id=0, device="cpu", memory_limit_mb=512)
...
async def test_worker_acquisition():
    ...
    config = ResourceConfig(max_workers=2, worker_timeout_secs=10, worker_memory_mb=512)
...
async def test_multiple_worker_acquisition():
    ...
    config = ResourceConfig(max_workers=3, worker_timeout_secs=10, worker_memory_mb=512)
