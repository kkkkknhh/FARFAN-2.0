...
def test_metrics_collector():
    ...
    try:
        from orchestration.unified_orchestrator import MetricsCollector, PipelineStage, StageMetrics
        import time
...
def test_circular_dependency_resolution():
    ...
    try:
        ...
        orchestrator.prior_store.update_mechanism_prior('tecnico', initial_prior * 0.8, 'penalty')
