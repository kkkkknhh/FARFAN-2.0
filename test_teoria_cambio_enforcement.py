...
class TestTeoriaCambioEnforcement(unittest.TestCase):
    ...
    def test_canonical_chain_valid_sequence(self):
        ...
        self.assertTrue(resultado.es_valida, 
                       "Valid canonical chain should pass validation")
        self.assertEqual(len(resultado.violaciones_orden), 0,
                        "Valid chain should have no order violations")
        self.assertEqual(len(resultado.categorias_faltantes), 0,
    ...
    def test_canonical_chain_skip_violation(self):
        ...
        self.assertFalse(resultado.es_valida,
                        "Graph with skip should be invalid")
        self.assertIn(("N1", "N4"), resultado.violaciones_orden,
                     "Should detect INSUMOS→RESULTADOS skip violation")
        self.assertEqual(len(resultado.violaciones_orden), 1,
    ...
    def test_canonical_chain_backward_violation(self):
        ...
        # Assert: Should detect violation
        self.assertFalse(resultado.es_valida,
                        "Graph with backward edge should be invalid")
        self.assertIn(("N3", "N2"), resultado.violaciones_orden,
    ...
    def test_canonical_chain_multiple_violations(self):
        ...
        self.assertGreaterEqual(len(resultado.violaciones_orden), 3,
    ...
    def test_canonical_chain_missing_categories(self):
        ...
        self.assertFalse(resultado.es_valida,
                        "Graph with missing categories should be invalid")
        self.assertGreater(len(resultado.categorias_faltantes), 0,
    ...
    def test_enforcement_at_construction_time(self):
        ...
        self.assertEqual(G.number_of_edges(), 1,
                        "Graph construction should be permissive")
        
        # But validation should fail
        resultado = self.tc.validacion_completa(G)
        self.assertFalse(resultado.es_valida,
                        "Validation should detect invalid structure")
    ...
    def test_complete_path_detection(self):
        ...
        self.assertGreater(len(resultado.caminos_completos), 0,
