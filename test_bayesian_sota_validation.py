...
class TestSemanticDistanceCalibration(unittest.TestCase):
    ...
    def test_beta_params_high_strength(self):
        ...
        self.assertGreater(
            alpha, beta, msg="High strength should result in alpha > beta"
        )
...
class TestMCMCConvergence(unittest.TestCase):
    ...
    def test_reproducible_seed_initialization(self):
        ...
        posterior1 = engine1.sample_mechanism_posterior(
            self.prior, self.evidence, self.config
        )
        posterior2 = engine2.sample_mechanism_posterior(
            self.prior, self.evidence, self.config
        )
        ...
        self.assertAlmostEqual(
            posterior1.posterior_std,
            posterior2.posterior_std,
            places=4,
    ...
    def test_convergence_diagnostic_returns_status(self):
        ...
        self.assertIsInstance(
            convergence, bool, msg="Convergence diagnostic must return boolean"
        )
        # With good evidence, should converge
        self.assertTrue(
            convergence, msg="Should converge with good evidence and sufficient draws"
        )
    ...
    def test_hdi_interval_extraction_90(self):
        ...
        self.assertLess(
            width_90, width_95, msg="90% HDI should be narrower than 95% HDI"
        )
    ...
    def test_posterior_samples_available(self):
        ...
        self.assertTrue(
            np.all((posterior.samples >= 0) & (posterior.samples <= 1)),
...
class TestHoopTestLogic(unittest.TestCase):
    ...
    def test_necessity_entity_presence(self):
        ...
        self.assertNotIn(
            "entity", result.missing, msg="Entity should not be in missing list"
        )
    ...
    def test_necessity_activity_presence(self):
        ...
        self.assertNotIn(
            "activity", result.missing, msg="Activity should not be in missing list"
        )
    ...
    def test_necessity_budget_presence(self):
        ...
        self.assertNotIn(
            "budget", result.missing, msg="Budget should not be in missing list"
        )
    ...
    def test_necessity_timeline_presence(self):
        ...
        self.assertNotIn(
            "timeline", result.missing, msg="Timeline should not be in missing list"
        )
...
class TestMechanismTypeCoherence(unittest.TestCase):
    ...
    def test_verb_coherence_tecnico(self):
        ...
        self.assertGreater(
            coherence, 0.7, msg="Technical verbs should have high coherence"
        )
    ...
    def test_verb_coherence_politico(self):
        ...
        self.assertGreater(
            coherence, 0.5, msg="Political verbs should have reasonable coherence"
        )
...
class TestEpistemicUncertainty(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.context = ColombianMunicipalContext(
            overall_pdm_embedding=np.random.randn(384)
            / np.linalg.norm(np.random.randn(384))
        )
    ...
    def _test_mechanism_type_uncertainty(self, mech_type: str, verbs: List[str]):
        ...
        evidence = MechanismEvidence(
            type=mech_type, verb_sequence=verbs, entity="Test Entity", budget=1000000.0
        )
    ...
    def test_uncertainty_differentiation_across_types(self):
        ...
        self.assertLess(
            politico.confidence_interval[0], politico.confidence_interval[1]
        )
