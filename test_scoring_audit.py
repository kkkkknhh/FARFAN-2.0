...
class TestScoringAudit(unittest.TestCase):
    ...
    def _create_mock_responses(
        self, num_questions: int = 300, score: float = 0.75
    ) -> dict:
            ...
            for d in range(1, 7):  # D1-D6
                for q in range(1, 6):  # Q1-Q5
                    ...
                    responses[question_id] = MockResponse(
                        pregunta_id=question_id, nota_cuantitativa=score
                    )
                    question_num += 1
    ...
    def test_matrix_structure_missing_questions(self):
        ...
        self.assertTrue(
            any(
                i.category == "matrix_structure"
                for i in self.auditor.report.micro_issues
            )
        )
    ...
    def test_micro_scores_out_of_range(self):
        ...
        self.assertTrue(
            any(i.category == "micro_scoring" for i in self.auditor.report.micro_issues)
        )
    ...
    def test_d6_theory_of_change_below_threshold(self):
        ...
        self.assertEqual(
            len(self.auditor.report.d6_scores_below_threshold), 50
        )  # 10 policies × 5 questions
        self.assertTrue(
            any(
                i.category == "d6_theory_of_change"
                for i in self.auditor.report.rubric_issues
            )
        )
    ...
    def test_rubric_thresholds_distribution(self):
        ...
        self.assertTrue(
            self.auditor.report.rubric_mappings_valid
            or len(self.auditor.report.rubric_issues) > 0
        )
    ...
    def test_macro_alignment_score_consistency(self):
        ...
        macro_report = {
            "evaluacion_global": {"score_global": 0.75, "total_preguntas": 300}
        }
    ...
    def test_macro_alignment_score_mismatch(self):
        ...
        self.assertTrue(
            any(
                i.category == "macro_convergence"
                for i in self.auditor.report.macro_issues
            )
        )
    ...
    def test_dnp_integration_valid(self):
        ...
        macro_report = {"evaluacion_global": {"score_dnp_compliance": 75.0}}
    ...
    def test_complete_audit_workflow(self):
        ...
        macro_report = {
            "evaluacion_global": {"score_global": 0.75, "score_dnp_compliance": 75.0},
