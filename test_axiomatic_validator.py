...
class TestAxiomaticValidator(unittest.TestCase):
    ...
    def test_high_contradiction_density(self):
        ...
        chunks = [
            SemanticChunk(
                text="El presupuesto aumentará en un 50%.", dimension="ESTRATEGICO"
            ),
            SemanticChunk(
                text="El presupuesto disminuirá en un 30%.", dimension="ESTRATEGICO"
            ),
        ]
    ...
    def test_ontology_initialization(self):
        ...
        custom_ontology = PDMOntology(
            canonical_chain=["A", "B", "C"], dimensions=["D1", "D2"]
        )
