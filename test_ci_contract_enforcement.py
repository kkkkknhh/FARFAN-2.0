...
class TestOrchestratorContractChecker(unittest.TestCase):
    ...
    def test_detects_missing_assertions(self):
        ...
        assertion_violations = [v for v in violations if v["type"] == "MISSING_ASSERTION"]
    ...
    def test_detects_missing_phase_result(self):
        ...
        phase_result_violations = [v for v in violations if v["type"] == "MISSING_PHASE_RESULT"]
    ...
    def test_detects_missing_audit_logging(self):
        ...
        audit_violations = [v for v in violations if v["type"] == "MISSING_AUDIT_LOGGING"]
